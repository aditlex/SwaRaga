          ...
          <div className="row">
            <div className="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
              <div className="product d-flex flex-column">
                <a href="/detailproduct" className="img-prod">
                  <img
                    className="img-fluid"
            ...
            <div className="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
              <div className="product d-flex flex-column">
                ...
                <div className="text py-3 pb-4 px-3">
                  ...
                  <p className="bottom-area d-flex px-3">
                    <a href="/detailproduct" className="add-to-cart text-center py-2 mr-1">
                      <span>
                        Add to cart <i className="ion-ios-add ml-1" />
                      </span>
                    </a>
                    <a href="/detailproduct" className="buy-now text-center py-2">
                      Buy now
                      <span>
                        <i className="ion-ios-cart ml-1" />
                      </span>
