    ...
    <div className="container">
      <div className="row justify-content-center">
        <div className="col-md-8 heading-section text-center mb-4 ftco-animate">
          ...
          <h4 className="mb-2 ml-2">swaraga.bali</h4></div>
          </a>
          <p>
         ♻️Proudly Bali Local Brand With Traditional Touch #changingponcho handwoven #endekbali #rashvest you need for #swim #surf #yoga etc
            DM for ORDER
          </p>
        </div>
      </div>
      ...
      <div className="row mb-5">
        <div className="col-md">
          <div className="ftco-footer-widget mb-4">
            <h2 className="ftco-heading-2">SwaRga</h2>
            <p>
